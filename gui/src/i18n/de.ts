...
export const de: Record<TKey, string> = {
  ...
  "usage.machine.label": "Rechner",
  "usage.machine.all": "Alle",
...
"common.discard": "Verwerfen",
  ...
  "dash.provider.ready": "Bereit",
  "dash.provider.needsSetup": "Einrichtung erforderlich",
  "dash.provider.disabled": "Deaktiviert",
  "dash.provider.keysCoolingDown": "{count} Schlüssel warten",
  "dash.provider.keysCoolingDownUntil": "{count} Schlüssel warten bis {until}",
  ...
  "models.tab.health": "Anbieterstatus",
  ...
  "models.subtitle.health": "Prüft, ob jeder konfigurierte Modellanbieter mit den aktuellen Anmeldedaten erreichbar ist.",
  "models.health.checkAll": "Alle prüfen",
  "models.health.configuration": "Konfiguration",
  "models.health.liveStatus": "Live-Prüfung",
  "models.health.latency": "Latenz",
  "models.health.configured": "Konfiguriert",
...
"codexSet.dialog.notRendered": "In der gelesenen Runde hat diese Ebene nichts gesendet. Abschnitte werden nur bei Änderungen erneut gesendet, daher kann eine einzelne Stichprobe sie nicht enthalten.",
  ...
  "usage.profile.badge": "Lokaler Proxy",
  "usage.stat.lifetimeTokens": "Tokens insgesamt",
  "usage.stat.peakDay": "Spitzentag",
  "usage.stat.requests": "Anfragen",
  "usage.stat.currentStreak": "Aktuelle Serie",
  "usage.stat.longestStreak": "Längste Serie",
  "usage.stat.daysValue": "{days} Tage",
  "usage.section.insights": "Aktivitätsübersicht",
  "usage.insight.topModel": "Meistgenutztes Modell",
  "usage.insight.providers": "Genutzte Anbieter",
  "usage.insight.activeDays": "Aktive Tage",
  "usage.insight.estimatedCost": "Geschätzte Kosten",
  "usage.section.topModels": "Meistgenutzte Modelle",
  "usage.topModels.runs": "{count} Anfragen",
  "usage.section.performance": "Leistung",
  "usage.perf.apiWallTime": "API-Gesamtzeit",
  "usage.perf.apiWallTimeHint": "Mindestens ein Modellaufruf aktiv",
  "usage.perf.taskTime": "Codex-Aufgabenzeit",
  "usage.perf.taskTimeHint": "Von Aufgabenstart bis Ende, Überlappungen einfach gezählt",
  "usage.perf.modelCallTime": "Modellaufrufzeit",
  "usage.perf.averageTtft": "Durchschnittliche TTFT",
  "usage.perf.endToEndTps": "Token/s (Ende-zu-Ende)",
  "usage.perf.decodeTps": "Token/s (Dekodierung)",
  "usage.perf.activeTasks": "{count} Aufgaben laufen gerade",
  "usage.perf.tokensPerSecondValue": "{value} Tok./s",
  "usage.section.effortBreakdown": "Aufschlüsselung Modell × Geschwindigkeit × Aufwand",
  "usage.effort.notRecorded": "Nicht erfasst",
  "usage.col.speed": "Geschwindigkeit",
  "usage.speed.fast": "Schnell",
  "usage.speed.standard": "Standard",
  "usage.speed.downgraded": "Schnell herabgestuft",
  "usage.speed.unknown": "Nicht erfasst",
  "usage.col.requestedEffort": "Angeforderter Aufwand",
  "usage.col.effectiveEffort": "Effektiver Aufwand",
  "usage.col.modelCallTime": "Aufrufzeit",
  "usage.col.inputTokens": "Eingabe",
  "usage.col.outputTokens": "Ausgabe",
  "usage.col.avgTtft": "Ø TTFT",
  "usage.col.e2eTps": "E2E-Tok./s",
  "usage.col.decodeTps": "Dekodier-Tok./s",
  "usage.providerTooltip": "Anbieter: {provider}",
 ...
 "quota.fiveHourLimit": "5-Stunden-Limit",
  ...
  "pws.attention.providerDisabled": "Provider ist deaktiviert",
  "pws.attention.keyDisabled": "Upstream-API-Schlüssel ist deaktiviert",
  "pws.keyCoolingDownUntil": "Ratenbegrenzt bis {until}",
  "pws.keyDisabled": "Der Upstream-API-Schlüssel dieses Providers ist deaktiviert. Ersetzen oder aktivieren Sie ihn, bevor Sie Datenverkehr hierher leiten.",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "cws.field.cooldownMs": "Fehler-Cooldown",
  "cws.field.cooldownShared": "Über Anfragen hinweg",
  "cws.field.cooldownRequest": "Nur aktuelle Anfrage",
  "cws.field.cooldownHint": "Legt fest, ob ein fehlgeschlagenes Ziel auch für spätere Anfragen oder nur für die aktuelle Failover-Kette gesperrt bleibt.",
