...
"common.discard": "버리기",
  ...
  "dash.col.model": "모델",
  "dash.col.status": "상태",
  "dash.provider.ready": "준비됨",
  "dash.provider.needsSetup": "설정 필요",
  "dash.provider.disabled": "비활성화됨",
  "dash.provider.keysCoolingDown": "키 {count}개 대기 중",
  "dash.provider.keysCoolingDownUntil": "키 {count}개가 {until}까지 대기 중",
  ...
  "models.subtitle.health": "현재 인증 정보로 구성된 각 모델 프로바이더에 연결할 수 있는지 확인합니다.",
  "models.health.checkAll": "모두 확인",
  "models.health.configuration": "구성",
  "models.health.liveStatus": "실시간 확인",
  "models.health.latency": "지연 시간",
  "models.health.configured": "구성됨",
...
"codexSet.dialog.notRendered": "확인한 턴에서는 이 레이어가 아무것도 보내지 않았습니다. 각 섹션은 내용이 바뀔 때만 다시 전송되므로, 한 번 확인한 것만으로는 빠져 보일 수 있습니다.",
  ...
  "usage.stat.currentStreak": "현재 연속 기록",
  "usage.stat.longestStreak": "최장 연속 기록",
  "usage.stat.daysValue": "{days}일",
  "usage.section.insights": "활동 인사이트",
  "usage.insight.topModel": "가장 많이 사용한 모델",
  "usage.insight.providers": "사용한 공급자",
  "usage.insight.activeDays": "활성 일수",
  "usage.insight.estimatedCost": "예상 비용",
  "usage.section.topModels": "주요 모델",
  "usage.topModels.runs": "{count}회 요청",
  "usage.section.performance": "성능",
  "usage.perf.apiWallTime": "API 경과 시간",
  "usage.perf.apiWallTimeHint": "모델 호출이 하나 이상 진행 중인 시간",
  "usage.perf.taskTime": "Codex 작업 시간",
  "usage.perf.taskTimeHint": "작업 시작부터 종료까지, 중복은 한 번만 계산",
  "usage.perf.modelCallTime": "모델 호출 시간",
  "usage.perf.averageTtft": "평균 TTFT",
  "usage.perf.endToEndTps": "엔드투엔드 토큰/초",
  "usage.perf.decodeTps": "디코딩 토큰/초",
  "usage.perf.activeTasks": "{count}개 작업 실행 중",
  "usage.perf.tokensPerSecondValue": "{value} 토큰/초",
  "usage.section.effortBreakdown": "모델 × 속도 × 추론 강도 분석",
  "usage.effort.notRecorded": "기록되지 않음",
  "usage.col.speed": "속도",
  "usage.speed.fast": "빠름",
  "usage.speed.standard": "표준",
  "usage.speed.downgraded": "빠른 모드 하향",
  "usage.speed.unknown": "기록되지 않음",
  "usage.col.requestedEffort": "요청된 강도",
  "usage.col.effectiveEffort": "적용된 강도",
  "usage.col.modelCallTime": "호출 시간",
  "usage.col.inputTokens": "입력",
  "usage.col.outputTokens": "출력",
  "usage.col.avgTtft": "평균 TTFT",
  "usage.col.e2eTps": "E2E 토큰/초",
  "usage.col.decodeTps": "디코딩 토큰/초",
  "usage.providerTooltip": "프로바이더: {provider}",
 ...
 "quota.fiveHourLimit": "5시간 한도",
  ...
  "pws.attention.providerDisabled": "제공자가 비활성화됨",
  "pws.attention.keyDisabled": "업스트림 API 키가 비활성화됨",
  "pws.keyCoolingDownUntil": "{until}까지 속도 제한됨",
  "pws.keyDisabled": "이 제공자의 업스트림 API 키가 비활성화되었습니다. 트래픽을 보내기 전에 교체하거나 다시 활성화하세요.",
  "pws.cell.auth": "인증",
  "pws.cell.note": "메모",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "cws.field.cooldownMs": "실패 쿨다운",
  "cws.field.cooldownShared": "요청 간 공유",
  "cws.field.cooldownRequest": "현재 요청만",
  "cws.field.cooldownHint": "실패한 대상을 이후 요청에서도 제외할지, 현재 장애 조치 체인에서만 제외할지 선택합니다.",
