...
"common.discard": "破棄",
  ...
  "dash.col.model": "モデル",
  "dash.col.status": "状態",
  "dash.provider.ready": "準備完了",
  "dash.provider.needsSetup": "設定が必要",
  "dash.provider.disabled": "無効",
  "dash.provider.keysCoolingDown": "{count} 個のキーが待機中",
  "dash.provider.keysCoolingDownUntil": "{count} 個のキーが {until} まで待機中",
  ...
  "models.subtitle.health": "設定済みの各モデルプロバイダーに現在の認証情報で接続できるか確認します。",
  "models.health.checkAll": "すべて確認",
  "models.health.configuration": "設定",
  "models.health.liveStatus": "ライブ確認",
  "models.health.latency": "レイテンシ",
  "models.health.configured": "設定済み",
 ...
 "logs.filter.conversation.clear": "クリア",
  ...
  "usage.stat.currentStreak": "現在の連続記録",
  "usage.stat.longestStreak": "最長連続記録",
  "usage.stat.daysValue": "{days} 日",
  "usage.section.insights": "アクティビティの分析",
  "usage.insight.topModel": "最も使用したモデル",
  "usage.insight.providers": "使用プロバイダー",
  "usage.insight.activeDays": "アクティブ日数",
  "usage.insight.estimatedCost": "推定コスト",
  "usage.section.topModels": "よく使うモデル",
  "usage.topModels.runs": "{count} リクエスト",
  "usage.section.performance": "パフォーマンス",
  "usage.perf.apiWallTime": "API 実時間",
  "usage.perf.apiWallTimeHint": "モデル呼び出しが1件以上進行中の時間",
  "usage.perf.taskTime": "Codex タスク時間",
  "usage.perf.taskTimeHint": "タスク開始から終了まで、重複は1回のみ計上",
  "usage.perf.modelCallTime": "モデル呼び出し時間",
  "usage.perf.averageTtft": "平均 TTFT",
  "usage.perf.endToEndTps": "エンドツーエンド トークン/秒",
  "usage.perf.decodeTps": "デコード トークン/秒",
  "usage.perf.activeTasks": "{count} 件のタスクが実行中",
  "usage.perf.tokensPerSecondValue": "{value} トークン/秒",
  "usage.section.effortBreakdown": "モデル × 速度 × 推論負荷の内訳",
  "usage.effort.notRecorded": "未記録",
  "usage.col.speed": "速度",
  "usage.speed.fast": "高速",
  "usage.speed.standard": "標準",
  "usage.speed.downgraded": "高速から降格",
  "usage.speed.unknown": "未記録",
  "usage.col.requestedEffort": "要求された負荷",
  "usage.col.effectiveEffort": "実際の負荷",
  "usage.col.modelCallTime": "呼び出し時間",
  "usage.col.inputTokens": "入力",
  "usage.col.outputTokens": "出力",
  "usage.col.avgTtft": "平均 TTFT",
  "usage.col.e2eTps": "E2E トークン/秒",
  "usage.col.decodeTps": "デコード トークン/秒",
  "usage.providerTooltip": "プロバイダー: {provider}",
 ...
 "quota.fiveHourLimit": "5 時間上限",
  ...
  "pws.attention.providerDisabled": "プロバイダーは無効です",
  "pws.attention.keyDisabled": "上流 API キーは無効です",
  "pws.keyCoolingDownUntil": "{until} までレート制限中",
  "pws.keyDisabled": "このプロバイダーの上流 API キーは無効です。トラフィックを送る前に交換または再有効化してください。",
  "pws.cell.auth": "認証",
  "pws.cell.note": "メモ",
...
"codexSet.dialog.notRendered": "確認したターンでは、このレイヤーは何も送信していません。各セクションは内容が変わったときだけ再送されるため、一度の確認では欠けて見えることがあります。",
  ...
  "cws.field.cooldownMs": "障害時のクールダウン",
  "cws.field.cooldownShared": "リクエスト間で共有",
  "cws.field.cooldownRequest": "現在のリクエストのみ",
  "cws.field.cooldownHint": "失敗したターゲットを後続リクエストでも除外するか、現在のフェイルオーバーチェーン内だけで除外するかを選びます。",
