...
"common.discard": "Discard",
  ...
  "dash.provider.ready": "Ready",
  "dash.provider.needsSetup": "Needs setup",
  "dash.provider.disabled": "Disabled",
  "dash.provider.keysCoolingDown": "{count} keys cooling down",
  "dash.provider.keysCoolingDownUntil": "{count} keys cooling down until {until}",
  ...
  "models.tab.health": "Provider health",
  ...
  "models.subtitle.health": "Check whether each configured model provider can be reached with its current credentials.",
  "models.health.checkAll": "Check all",
  "models.health.configuration": "Configuration",
  "models.health.liveStatus": "Live check",
  "models.health.latency": "Latency",
  "models.health.configured": "Configured",
 ...
 "logs.filter.conversation.clear": "Clear",
  ...
  "usage.historyTruncated": "Partial history: totals use only loaded records; earlier file entries were omitted by the read limit.",
  "usage.historyTruncatedWindow": "Partial history: loaded request start times span {start} to {end}. Earlier file entries were omitted by the read limit and may overlap the selected range.",
  "usage.range.30d": "30d",
  "usage.range.7d": "7d",
  ...
  "usage.stat.currentStreak": "Current streak",
  "usage.stat.longestStreak": "Longest streak",
  "usage.stat.daysValue": "{days} days",
  "usage.section.insights": "Activity insights",
  "usage.insight.topModel": "Most used model",
  "usage.insight.providers": "Providers used",
  "usage.insight.activeDays": "Active days",
  "usage.insight.estimatedCost": "Estimated cost",
  "usage.section.topModels": "Most used models",
  "usage.topModels.runs": "{count} requests",
  "usage.section.performance": "Performance",
  "usage.perf.apiWallTime": "API wall time",
  "usage.perf.apiWallTimeHint": "At least one model call in flight",
  "usage.perf.taskTime": "Codex task time",
  "usage.perf.taskTimeHint": "Task start to finish, overlaps counted once",
  "usage.perf.modelCallTime": "Model call time",
  "usage.perf.averageTtft": "Average TTFT",
  "usage.perf.endToEndTps": "End-to-end tokens/sec",
  "usage.perf.decodeTps": "Decode tokens/sec",
  "usage.perf.activeTasks": "{count} tasks running now",
  "usage.perf.tokensPerSecondValue": "{value} tok/s",
  "usage.section.effortBreakdown": "Model × speed × effort breakdown",
  "usage.effort.notRecorded": "Not recorded",
  "usage.col.speed": "Speed",
  "usage.speed.fast": "Fast",
  "usage.speed.standard": "Standard",
  "usage.speed.downgraded": "Fast downgraded",
  "usage.speed.unknown": "Not recorded",
  "usage.col.requestedEffort": "Requested effort",
  "usage.col.effectiveEffort": "Effective effort",
  "usage.col.modelCallTime": "Call time",
  "usage.col.inputTokens": "Input",
  "usage.col.outputTokens": "Output",
  "usage.col.avgTtft": "Avg TTFT",
  "usage.col.e2eTps": "E2E tok/s",
  "usage.col.decodeTps": "Decode tok/s",
  "usage.providerTooltip": "Provider: {provider}",
 ...
 "quota.fiveHourLimit": "5-hour limit",
  ...
  "pws.attention.providerDisabled": "Provider is disabled",
  "pws.attention.keyDisabled": "Upstream API key is disabled",
  "pws.keyCoolingDownUntil": "Rate limited until {until}",
  "pws.keyDisabled": "This provider’s upstream API key is disabled. Replace or re-enable it before routing traffic here.",
...
"codexSet.dialog.notRendered": "This layer sent nothing on the turn we read. Sections are only re-sent when they change, so an unchanged layer is absent from a single sample.",
  ...
  "cws.field.cooldownMs": "Failure cooldown",
  "cws.field.cooldownShared": "Share across requests",
  "cws.field.cooldownRequest": "Current request only",
  "cws.field.cooldownHint": "Choose whether a failed target stays unavailable to later requests or only for the current failover chain.",
