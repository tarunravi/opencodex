...
"common.discard": "Отбросить",
  ...
  "dash.provider.ready": "Готов",
  "dash.provider.needsSetup": "Требуется настройка",
  "dash.provider.disabled": "Отключен",
  "dash.provider.keysCoolingDown": "Ключей в ожидании: {count}",
  "dash.provider.keysCoolingDownUntil": "Ключей в ожидании до {until}: {count}",
  ...
  "models.tab.health": "Состояние провайдеров",
  ...
  "models.subtitle.health": "Проверьте доступность каждого настроенного провайдера моделей с текущими учетными данными.",
  "models.health.checkAll": "Проверить все",
  "models.health.configuration": "Конфигурация",
  "models.health.liveStatus": "Проверка",
  "models.health.latency": "Задержка",
  "models.health.configured": "Настроен",
 ...
 "logs.filter.conversation.clear": "Сбросить",
  ...
  "usage.stat.currentStreak": "Текущая серия",
  "usage.stat.longestStreak": "Самая длинная серия",
  "usage.stat.daysValue": "{days} дн.",
  "usage.section.insights": "Обзор активности",
  "usage.insight.topModel": "Самая используемая модель",
  "usage.insight.providers": "Использовано провайдеров",
  "usage.insight.activeDays": "Активные дни",
  "usage.insight.estimatedCost": "Оценочная стоимость",
  "usage.section.topModels": "Часто используемые модели",
  "usage.topModels.runs": "{count} запросов",
  "usage.section.performance": "Производительность",
  "usage.perf.apiWallTime": "Время API (по часам)",
  "usage.perf.apiWallTimeHint": "Хотя бы один вызов модели выполняется",
  "usage.perf.taskTime": "Время задачи Codex",
  "usage.perf.taskTimeHint": "От начала до конца задачи, перекрытия считаются один раз",
  "usage.perf.modelCallTime": "Время вызовов модели",
  "usage.perf.averageTtft": "Средний TTFT",
  "usage.perf.endToEndTps": "Сквозные токены/с",
  "usage.perf.decodeTps": "Токены/с при декодировании",
  "usage.perf.activeTasks": "Сейчас выполняется задач: {count}",
  "usage.perf.tokensPerSecondValue": "{value} ток./с",
  "usage.section.effortBreakdown": "Разбивка модель × скорость × уровень рассуждений",
  "usage.effort.notRecorded": "Не записано",
  "usage.col.speed": "Скорость",
  "usage.speed.fast": "Быстро",
  "usage.speed.standard": "Стандарт",
  "usage.speed.downgraded": "Быстрый режим снижен",
  "usage.speed.unknown": "Не записано",
  "usage.col.requestedEffort": "Запрошенный уровень",
  "usage.col.effectiveEffort": "Фактический уровень",
  "usage.col.modelCallTime": "Время вызова",
  "usage.col.inputTokens": "Ввод",
  "usage.col.outputTokens": "Вывод",
  "usage.col.avgTtft": "Ср. TTFT",
  "usage.col.e2eTps": "Сквозные ток./с",
  "usage.col.decodeTps": "Декод. ток./с",
  "usage.providerTooltip": "Провайдер: {provider}",
 ...
 "quota.fiveHourLimit": "5-часовой лимит",
  ...
  "pws.attention.providerDisabled": "Провайдер отключен",
  "pws.attention.keyDisabled": "API-ключ вышестоящего сервиса отключен",
  "pws.keyCoolingDownUntil": "Ограничение запросов до {until}",
  "pws.keyDisabled": "API-ключ вышестоящего сервиса для этого провайдера отключен. Замените или включите его перед маршрутизацией трафика.",
...
"codexSet.dialog.notRendered": "На прочитанном нами шаге этот слой ничего не отправил. Разделы пересылаются только при изменении, поэтому в одной выборке слой может отсутствовать.",
  ...
  "cws.field.cooldownMs": "Пауза после сбоя",
  "cws.field.cooldownShared": "Между запросами",
  "cws.field.cooldownRequest": "Только текущий запрос",
  "cws.field.cooldownHint": "Выберите, останется ли цель недоступной для следующих запросов или только в текущей цепочке переключения.",
