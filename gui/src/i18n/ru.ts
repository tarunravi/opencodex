...
"common.discard": "Отбросить",
  ...
  "models.groupMore": "Показать дополнительные действия провайдера",
  "models.subtitleAria": "Как работает каталог",
  "models.orderHintAria": "Как определяется порядок в выборе",
