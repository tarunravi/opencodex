...
"common.discard": "丢弃",
  ...
  "dash.col.model": "模型",
  "dash.col.status": "状态",
  "dash.provider.ready": "就绪",
  "dash.provider.needsSetup": "需要设置",
  "dash.provider.disabled": "已停用",
  "dash.provider.keysCoolingDown": "{count} 个密钥正在等待",
  "dash.provider.keysCoolingDownUntil": "{count} 个密钥等待至 {until}",
  ...
  "models.subtitle.health": "检查每个已配置的模型提供方能否使用当前凭据访问。",
  "models.health.checkAll": "检查全部",
  "models.health.configuration": "配置",
  "models.health.liveStatus": "实时检查",
  "models.health.latency": "延迟",
  "models.health.configured": "已配置",
...
"codexSet.dialog.notRendered": "在我们读取的那一轮中，此层没有发送任何内容。各部分仅在内容变化时才会重新发送，因此单次采样可能看不到它。",
  ...
  "usage.stat.currentStreak": "当前连续天数",
  "usage.stat.longestStreak": "最长连续天数",
  "usage.stat.daysValue": "{days} 天",
  "usage.section.insights": "活动洞察",
  "usage.insight.topModel": "最常用模型",
  "usage.insight.providers": "使用的提供商",
  "usage.insight.activeDays": "活跃天数",
  "usage.insight.estimatedCost": "预估费用",
  "usage.section.topModels": "常用模型",
  "usage.topModels.runs": "{count} 次请求",
  "usage.section.performance": "性能",
  "usage.perf.apiWallTime": "API 实际耗时",
  "usage.perf.apiWallTimeHint": "至少一个模型调用进行中的时间",
  "usage.perf.taskTime": "Codex 任务时间",
  "usage.perf.taskTimeHint": "从任务开始到结束，重叠只计一次",
  "usage.perf.modelCallTime": "模型调用时间",
  "usage.perf.averageTtft": "平均 TTFT",
  "usage.perf.endToEndTps": "端到端 token/秒",
  "usage.perf.decodeTps": "解码 token/秒",
  "usage.perf.activeTasks": "{count} 个任务正在运行",
  "usage.perf.tokensPerSecondValue": "{value} token/秒",
  "usage.section.effortBreakdown": "模型 × 速度 × 推理强度明细",
  "usage.effort.notRecorded": "未记录",
  "usage.col.speed": "速度",
  "usage.speed.fast": "快速",
  "usage.speed.standard": "标准",
  "usage.speed.downgraded": "快速模式已降级",
  "usage.speed.unknown": "未记录",
  "usage.col.requestedEffort": "请求强度",
  "usage.col.effectiveEffort": "实际强度",
  "usage.col.modelCallTime": "调用时间",
  "usage.col.inputTokens": "输入",
  "usage.col.outputTokens": "输出",
  "usage.col.avgTtft": "平均 TTFT",
  "usage.col.e2eTps": "端到端 token/秒",
  "usage.col.decodeTps": "解码 token/秒",
  "usage.providerTooltip": "提供方：{provider}",
 ...
 "quota.fiveHourLimit": "5 小时限额",
  ...
  "pws.attention.providerDisabled": "提供商已停用",
  "pws.attention.keyDisabled": "上游 API 密钥已停用",
  "pws.keyCoolingDownUntil": "速率受限至 {until}",
  "pws.keyDisabled": "此提供商的上游 API 密钥已停用。请在向其路由流量前更换或重新启用该密钥。",
  "pws.cell.auth": "认证",
  "pws.cell.note": "备注",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "cws.field.cooldownMs": "失败冷却",
  "cws.field.cooldownShared": "跨请求共享",
  "cws.field.cooldownRequest": "仅当前请求",
  "cws.field.cooldownHint": "选择失败目标是继续对后续请求不可用，还是只在当前故障转移链中跳过。",
