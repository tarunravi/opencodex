...
| #2690 | normalize xAI Responses root tool schemas | **L3** | 926/289 across 8 files including a 430-line new module and a 269-line deletion from `openai-chat.ts`. Overlaps #2684 conceptually. Take the xai-tool-schema normalization; leave the openai-chat refactor out of a bug round. |
